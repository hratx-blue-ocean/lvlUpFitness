...
const bwCore = new BodyWeight({
    ...
    }, 
    {
        ...
        amount: '10 each side',
        description: ['Standard push-ups not cutting it? For a variation, after coming back up into a ',
        'starting push-up position, rotate your body to the right and extend your right hand overhead, ',
        'forming a T with your arms and torso. Return to the starting position, do a regular push-up, and ',
    ...
    }, 
    {
        name: 'Side plank',
        amount: '30-60 seconds, 2 sets',
        description: ['Lie faceup and roll to the side. Come up onto one foot and elbow. Make sure your hips ',
        'are lifted and your core is engaged. Hang tight for 30 to 60 seconds — or as long as you can stomach!'],
        intensity: 'Beginner',
        favorite: false
    }, 
    {
    ...
    {
        name: 'Crunch',
        amount: '30-60 seconds, or 50-75 reps, 2-3 sets',
        description: ['Before anyone’s crowned Cap’n Crunch, remember: Form is key. Lie faceup with knees ',
        'bent and feet flat on the floor. With hands behind head, lower your chin slightly. Peel head and ',
        'shoulders off the floor while engaging your core. Continue curling up until your upper back is off ',
        'the mat. Hold briefly, then slowly lower torso back toward the floor.'],
        intensity: 'Beginner',
        favorite: false
    }, 
    {
        name: 'Segmental Rotation',
        amount: '5 seconds each side, 10 reps, 2-3 sets',
        description: ['Let’s target those obliques! Lying faceup with your knees bent and core tight, let ',
        'your knees fall gradually to the left until you feel a good stretch. Hold for 5 seconds, return to ',
        'center, and repeat on the right.'],
        intensity: 'Intermediate',
        favorite: false
    }, 
    {
        name: 'Shoulder bridge',
        amount: '10 reps per leg, 2-3 sets',
        description: ['Lie faceup with knees bent and feet hip-width apart. Place arms at your sides and lift',
        ' your spine and hips. Only your head, feet, arms, and shoulders should be on the floor. Lift one ',
        'leg, keeping your core tight. Slowly bring leg back down, then lift back up. Try to do 10 reps per ',
    ...
    }, 
    {
        ...
        amount: '5 seconds, 10 reps, 2-3 sets',
        description: ['Lie faceup with knees bent and feet flat on the floor. Tighten abs and raise right ',
        'leg, with knee bent at a 90-degree angle. Push right hand on top of lifted knee, using core ',
        'to create pressure between hand and knee. Hold for 5 seconds, then lower back down. Repeat with ',
        'left hand and knee.'],
        intensity: 'Intermediate',
        favorite: false
    }, 
    {
        ...
        amount: '5 sconds, 10 reps, 2-3 sets',
        description: ['Two legs are twice the fun! Follow the same rundown for the single-leg press ',
        '(see Single-leg abdominal press), but bring both legs up at the same time, pushing ',
        'hands against knees.'],
        intensity: 'Advanced',
        favorite: false
    }, 
    {
        ...
        amount: '10 each side, 2-3 sets',
        description: ['Want to be a speed demon without getting off the floor? Lie faceup with legs straight',
        ' and arms by your sides, elbows bent at a 90-degree angle. Now, sit up and bring left knee toward ',
        'right elbow. Return to the starting position. Repeat on the other side.'],
        intensity: 'Advanced',
        favorite: false
    }]
});
