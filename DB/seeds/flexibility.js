...
const flxUpper = new Flexibility({
    muscleGroup: 'Upper Body',
    type:[{
        name: 'Neck Stretch',
        amount: 'Hold for at least 30 seconds and then repeat on the other side.',
        description:['Start standing or sitting tall, and place one hand on your lower back, the other hand on the opposite side of your head.',
    ...
    },
    {
        ...
        amount: 'Hold for at least 30 seconds and then repeat on the other side.',
        description: ['Start standing or sitting tall. Bring one arm overhead and drop your forearm behind you, resting it on your back between your shoulder blades.',
    ...
    },
    {
        ...
        amount: 'Hold for at least 30 seconds and then repeat on the other side.',
        description: ['Start standing or sitting tall. Grab one arm above your elbow with your opposite hand, and pull it across your body toward your chest until you feel a stretch in your shoulder.',
    ...
    },
    {
        ...
        description: ['Sit on the floor with your feet flat and knees bent.',
    ...
    },
    {
        name: 'Chest Stretch',
        amount: 'Hold for at least 30 seconds.',
        description: ['Start standing tall, fingers interlocked behind you near your butt.',
    ...
    },
    {
        ...
        description:['Start standing or sitting tall. Extend one arm forward in front of you at shoulder height or just below.',
    ...
    },
    {
        ...
        amount: 'Hold for at least 30 seconds.',
        description: ['Start standing or sitting tall. Arms extended with palms facing inward. Cross fingers and bring palms to chest.',
...
const flxCore = new Flexibility({
    muscleGroup: 'Core',
    typre:[
    {
        name: 'Lower Back Stretch',
        amount: 'Hold for at least 30 seconds then repeat on the other side.',
        description: ['Lie faceup with your arms out to your sides, either straight or bent into the shape of a goal post (pictured above).',
    ...
    },
    {
        ...
        description: ['Sit tall on the floor with the soles of your feet together, knees bent out to sides.',
    ...
    },
    {
        name: 'Sphinx Pose',
        amount: 'Hold this stretch for 30 seconds to 2 minutes',
        description:['Lie on your stomach with your legs straight out behind you.',
    ...
    },
    {
        ...
        description:['Lie on your back.', 'Bring the soles of your feet together and allow your knees to open up and move closer to the floor.'],
        intensity: 'Low',
    ...
    },
    {
        ...
        description: ['Lie on your back and pull your knees into your chest with both hands.','Keep your lower back on the floor.'],
        intensity: 'Low',
    ...
    },
    {
        ...
        amount: 'Hold for 30 seconds to 2 minutes.',
        description: ['Kneel on your left knee. Place your right foot flat on the floor in front of you, knee bent.',
                        'Lean forward, stretching your left hip toward the floor.','Squeeze your butt; this will allow you to stretch your hip flexor even more.',
    ...
    },
    {
        name: '90/90 Stretch',
        amount: 'Hold for 30 seconds to 2 minutes.',
        description: ['Sit with your right knee bent at 90-degrees in front of you, calf perpendicular to your body and the sole of your foot facing to the left. Keep your right foot flexed.',
                        'Let your leg rest flat on the floor.', 'Place your left knee to the left of your body, and bend the knee so that your foot faces behind you. Keep your left foot flexed.',
    ...
    },
    {
        ...
        description: ['Sit on the edge of a cushion with both legs extended out in front and bend your right knee and place your foot to the outside of your left thigh.', 
                        ...
                        'Place your left arm around your right leg as though you’re hugging it, or bring your upper arm to the outside of your thigh.', 'epeat on the other side.'],
        intensity: 'Medium',
...
const flxLower = new Flexibility({
    muscleGroup: 'Lower Body',
    type: [
    {
        name: 'Standing Quad Stretch',
        amount: 'Maintain position for 30 seconds, repeat exercise 3 to 5 times with each leg.',
        description: ['While standing, hold onto a countertop or chair back to assist in balance.','Bend your knee back by grasping your ankle with one hand.',
    ...
    },
    {
        ...
        description: ['Sit on the floor with both legs out straight.', 'Bend the other leg at the knee and position the sole of that foot against your opposite inner thigh.',
    ...
    },
    {
        ...
        description: ['Stand and cross your right foot in front of your left.', 'Slowly lower your forehead to your right knee by bending at the waist.',
                        'Keep both knees straight.', 'Repeat for the other side by crossing your left foot in front of your right.'],
        intensity: 'Medium',
    ...
    },
    {
        ...
        amount: 'Hold this position for 15 to 30 seconds.',
        description: ['Stand with your feet staggered.', 'Bend your back knee and keep your front knee straight as you fold forward and grab onto your front foot underneath your toes',
                        'Pull up gently on your toes, feeling the stretch in your calf.', 'Repeat on the other side.'],
        intensity: 'Medium',
        targetMuscle: 'Calves',
        favorite: false
    },
    {
        ...
        description: ['Lie in a face-down position, propping your head on your left hand. Alternatively, you can lie on your side to perform this stretch.',
    ...
    },
    {
        ...
        description: ['Start by crossing the left foot behind the right.', 'Take the left arm up and gently lean to the right, pressing the hip out to feel a stretch down your outer thigh.'],
        intensity: 'Low',
    ...
    },
    {
        ...
        description: ['Sit on the floor with both legs extended out to the sides so that you\'re in a V.', 'Open your legs as wide as possible and flex your feet.',
...
module.exports = { flxUpper, flxCore , flxLower};
